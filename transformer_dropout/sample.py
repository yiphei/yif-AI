...
if __name__ == "__main__":
    ...
    device_type = 'cuda' if 'cuda' in SAMPLE_CONFIG.DEVICE else 'cpu' # for later use in torch.autocast
    ptdtype = {'float32': torch.float32, 'bfloat16': torch.bfloat16, 'float16': torch.float16}[SAMPLE_CONFIG.DTYPE]
