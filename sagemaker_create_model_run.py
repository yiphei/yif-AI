...
sagemaker_session.create_model(name="final-big-harry-potter-model-gpu-inference", role = role, container_defs=pytorch_model.prepare_container_def('ml.p3.8xlarge'))